...
- 目視確認は `docs/internal/VERIFY_CHECKLIST.md` に沿って実施します。必要に応じて手順をアップデートしてください。
...
- プロジェクトに貢献いただいた方は `docs/external/CONTRIBUTORS.md` で紹介しています。PR がマージされ次第、必要に応じて追加します。
